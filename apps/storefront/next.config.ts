...
const config: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/dealer", destination: "/wholesale/apply", permanent: true },
      { source: "/dealer/:path*", destination: "/wholesale/apply", permanent: true },
      { source: "/distributor", destination: "/wholesale/apply", permanent: true },
      { source: "/distributor/:path*", destination: "/b2b/dashboard", permanent: true },
      { source: "/shop", destination: "/products", permanent: true },
      { source: "/cart", destination: "/b2b/carts", permanent: true },
